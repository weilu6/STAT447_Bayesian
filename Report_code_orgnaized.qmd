...
In addition to the posterior inference, the prediction performances on the test data are also compared. The 95% credible intervals of the accuray on test data are almost identical (\[79.7%, 82.85%\] for normal model and \[79.8%, 82.85%\] for spike-and-slab priors). The predcition accuracy of the test data is slightly lower than that of the train data, but it is acceptable.
